...
export default function Card({ children, details }) {
  ...
  return (
    <>
      <ToastContainer />
      <div className="card-container overflow-x-auto flex flex-row flex-wrap justify-between">
        <div
          className="relative w-full md:w-[48%] max-w-[290px] min-w-[240px] border-2 max-h-[400px] min-h-[360px] size-100% h-auto hover:shadow-2xl flex flex-col justify-between m-4"
