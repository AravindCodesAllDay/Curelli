...
export default function Subscribe() {
  return (
    <div className="flex flex-col items-center justify-center gap-4 sm:gap-8 relative bg-gray-100 p-4 sm:p-8 rounded-md shadow-md my-8 sm:my-12">
      ...
      <div className="w-full max-w-[400px] h-[40px] rounded-md overflow-hidden border border-solid border-[#4e4e4e] relative">
        <div className="w-[70px] h-[40px] absolute top-0 right-0">
