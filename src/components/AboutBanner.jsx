...
export default function AboutBanner() {
  return (
    <div className="px-4 md:px-8 py-6 md:py-12 relative bg-white">
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-start md:space-x-8 max-w-screen-xl mx-auto">
        <img
          className="w-full md:w-auto h-auto rounded-md hover:scale-105 mb-6 md:mb-0 md:mr-8 max-w-md"
          alt="Pancakes"
          src={img}
        />
        <div className="flex flex-col gap-6">
          <p className="font-bold text-[#40773b] text-lg md:text-4xl tracking-wide leading-normal">
