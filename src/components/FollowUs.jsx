...
export default function FollowUs() {
  return (
    <div className="flex flex-col items-center text-[#40773b] relative bg-gray-100 p-4 shadow-md mb-12 gap-4 justify-around">
      <h4 className="xs:text-base sm:text-lg md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl mb-2">
        Follow us on:
      </h4>
      <div className="flex items-center justify-center gap-8">
        <a
          ...
          target="_blank "
          className="text-xs lg:text-base sm:text-xs xl:text-lg 2xl:text-lg hover:scale-105"
        >
          <img
